...
final class BoardItemDTO {
  ...
  const BoardItemDTO({required this.id, required this.title, required this.category, required this.createdAt});
}
...
final class SortDTO {
  ...
  const SortDTO({required this.unsorted, required this.sorted, required this.empty});
}
